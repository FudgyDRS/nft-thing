...
const BlockBidCreate: FC = () => {
    ...
    <Text fontWeight={"1em"}>Create Bid</Text>
    <Text>Token ID: </Text>
    <Input paddingEnd="-0.1em" backgroundColor={"#7e7e7e"} value={inputValue1} onChange={handleChange1}/>
    <Text>Bid: </Text>
    <Input className="quantity" backgroundColor={"#7e7e7e"} value={inputValue2} onChange={handleChange2} marginBottom={"0.5em"}/>
    <TransferButton _from={account} _to={inputValue1} _id={Number(inputValue2)-1}/>
    </Box>);
}
 
export default BlockBidCreate;
