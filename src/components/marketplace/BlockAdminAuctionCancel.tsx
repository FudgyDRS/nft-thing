...
const BlockAdminAuctionCancel: FC = () => {
    ...
    <Text fontWeight={"1em"}>Admin Cancel Auction</Text>
    <Text>Token ID: </Text>
    <Input paddingEnd="-0.1em" marginBottom={"0.5em"} backgroundColor={"#7e7e7e"} value={inputValue1} onChange={handleChange1}/>
    <TransferButton _from={account} _to={inputValue1} _id={Number(inputValue2)-1}/>
    </Box>);
}
 
export default BlockAdminAuctionCancel;
