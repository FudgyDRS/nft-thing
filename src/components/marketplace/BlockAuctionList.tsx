...
const BlockAuctionList: FC = () => {
    ...
    <Text fontWeight={"1em"}>Create Auction</Text>
    <Text>Token ID: </Text>
    <Input paddingEnd="-0.1em" backgroundColor={"#7e7e7e"} value={inputValue1} onChange={handleChange1}/>
    <Text>Minimum Bid (fixed): </Text>
    <Input className="quantity" backgroundColor={"#7e7e7e"} value={inputValue2}/>
    <Text>Duration in Seconds (min 60 secs): </Text>
...
export default BlockAuctionList;
